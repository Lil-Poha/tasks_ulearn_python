"""
В порыве энтузиазме Вася рванулся писать сложное приложение на Python, использующее много сторонних модулей.
Однако он забыл про описание зависимостей, и теперь у него код не запускается!
